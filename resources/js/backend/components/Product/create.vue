                            ...
                            <el-form-item :inline-message="true" label-width="auto">
                                <div class="display:flex; flex-wrap:nowrap;">
                                    <el-popconfirm
                                        ...
                                        @confirm="()=>setAll()"
                                    >
                                        <el-button slot="reference" type="success" style="height: 50px; width: 80px;">Set All</el-button>
                                    </el-popconfirm>
                                    <el-popconfirm
                                        ...
                                        @confirm="()=>clearAll()"
                                    >
                                    <el-button slot="reference" type="danger" style="height: 50px; width: 80px;">Clear All</el-button>
                                ...
                                <div class="display:flex; flex-wrap:nowrap">
                                    <el-descriptions :column="2" border>
                                        <el-descriptions-item>
                                            ...
                                            <el-select multiple v-model="item['id_size']" placeholder="ví dụ: X, M, L, XL,...">
                                                <el-option
...
<!--                        </div>-->
            ...
            <div class="elevation-1 mt-2" style="padding: 14px; background-color: #ffffff; display: flex; justify-content: end;">
                <el-button :loading="loadingBtn" v-if="$route.params.id" type="success" @click="updateData()"><i class="el-icon-document-checked"></i> Cập nhật</el-button>
                <el-button :loading="loadingBtn" v-else type="success" @click="submitData()"><i class="el-icon-document-checked"></i> Lưu lại</el-button>
